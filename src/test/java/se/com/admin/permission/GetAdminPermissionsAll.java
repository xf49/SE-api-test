...
public class GetAdminPermissionsAll {
	...
	public void test() {
		...
		request.contentType(ContentType.JSON).get("/admin/permissions/all").then().statusCode(200);
		
		Response response = request.
				contentType(ContentType.JSON).get("/admin/permissions/all");
