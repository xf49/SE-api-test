...
public class GetAdminRolesAll {
	...
	public void test() {
		...
		request.contentType(ContentType.JSON).get("/admin/roles/all").then().statusCode(200);
		
		Response response = request.
				contentType(ContentType.JSON).get("/admin/roles/all");
