...
public class GetAdminCollections {
	...
	public void test() {
		...
		request.contentType(ContentType.JSON).get("/admin/collections").then().statusCode(200);
		
		Response response = request.
				contentType(ContentType.JSON).get("/admin/collections");
