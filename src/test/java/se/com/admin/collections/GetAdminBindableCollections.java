...
public class GetAdminBindableCollections {
	...
	public void test() {
		...
		request.contentType(ContentType.JSON).get("/admin/bindable/collections").then().statusCode(200);
		
		Response response = request.
				contentType(ContentType.JSON).get("/admin/bindable/collections");
